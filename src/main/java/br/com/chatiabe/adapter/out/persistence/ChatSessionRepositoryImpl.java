...
public class ChatSessionRepositoryImpl implements ChatSessionRepository {
    ...
    public ChatSessionRepositoryImpl(SpringDataChatSessionRepository springDataChatSessionRepository,
    ...
    public ChatSession save(ChatSession session) {
        var userEntity = springDataUserRepository.findById(session.getUserId())
                .orElseThrow(() -> new IllegalArgumentException("User not found: " + session.getUserId()));
        var entity = ChatSessionMapper.toEntity(session, userEntity);
