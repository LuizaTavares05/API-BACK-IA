...
public class MessageRepositoryImpl implements MessageRepository {
    ...
    public MessageRepositoryImpl(SpringDataMessageRepository springDataMessageRepository,
    ...
    public Message save(Message message) {
        var chatSessionEntity = springDataChatSessionRepository.findById(message.getChatSessionId())
                .orElseThrow(() -> new IllegalArgumentException("ChatSession not found: " + message.getChatSessionId()));
        var entity = MessageMapper.toEntity(message, chatSessionEntity);
